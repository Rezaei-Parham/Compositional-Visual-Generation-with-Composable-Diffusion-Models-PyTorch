...
def save_attention_maps(attention_maps, indices_to_alter, prompt, concept, timestep, output_path, seed=42):
    os.makedirs(f"{output_path}/{prompt}/{concept}/attention_maps/", exist_ok=True)
